...
SVMModel1=fitcsvm(trainData_hoi,trainLabel_hoi,'KernelFunction',kerType,'Cost',[0,cost;cost,0], 'Standardize',true);
...
SVMModel2=fitcsvm(trainData_oi,trainLabel_oi,'KernelFunction',kerType,'Cost',[0,cost;cost,0], 'Standardize',true);
