...
% Design PSO optim option and visualisation:
pso_option = struct('c1',2,'c2',2,'Max_iteration',10,'noP',5,'k',0.6,'w',2,...
    'wMin',0.4,'wMax',0.9,'dt',0.9, ...
    'popcmax',10^6,'popcmin',10^(-3),'popgmax',10^1,'popgmin',10^(-3));

[bestAccuracy,cost,gamma,trace] = psosvm2(trainData_hoi,trainLabel_hoi,trainData_oi,trainLabel_oi,testData,testLabel,pso_option);
